...
public class SysConfigController extends BaseController
{
     ...
     * 获取参数配置列表
     */
    @PreAuthorize("@dss.hasPermi('system:config:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@dss.hasPermi('system:config:export')")
    @PostMapping("/export")
     ...
     * 根据参数编号获取详细信息
     */
    @PreAuthorize("@dss.hasPermi('system:config:query')")
     ...
     * 新增参数配置
     */
    @PreAuthorize("@dss.hasPermi('system:config:add')")
     ...
     * 修改参数配置
     */
    @PreAuthorize("@dss.hasPermi('system:config:edit')")
     ...
     * 删除参数配置
     */
    @PreAuthorize("@dss.hasPermi('system:config:remove')")
