...
public class ChannelMerchantService implements IChannelMerchantService {
   ...
   // @Value("${yscard.agent.version}")
    ...
    public List<ExtMerchantInfo> selectChannelMerchantList(ExtMerchantInfo channelMerchantInfo) {
        return this.extMerchantInfoMapper.selectChannelMerchantList(channelMerchantInfo);
    }

    @Override
    public ExtMerchantInfo findMercInfoById(Long id) {
        return this.extMerchantInfoMapper.selectByPrimaryKey(id);
    }
    ...
    @Override
    public int auditMerchant(ExtMerchantInfo extMerchantInfo) {
        return this.extMerchantInfoMapper.updateByPrimaryKeySelective(extMerchantInfo);
    }
    ...
    @Override
    public int deleteMercByIds(Long[] ids) {
        return this.extMerchantInfoMapper.deleteMercByIds(ids);
    }
