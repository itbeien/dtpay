...
public class TradeCashout implements Serializable {
    ...
    public String getToAcctBankName() {
        return toAcctBankName;
    }

    public void setToAcctBankName(String toAcctBankName) {
        this.toAcctBankName = toAcctBankName == null ? null : toAcctBankName.trim();
    }
}