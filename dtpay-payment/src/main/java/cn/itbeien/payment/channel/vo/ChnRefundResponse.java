package cn.itbeien.payment.channel.vo;
 ...
 */
public class ChnRefundResponse extends ChannelVo {
	...
	public String toString() {
		return "ChnRefundResponse [bankRefundTradeSeq=" + bankRefundTradeSeq + ", refundStatus=" + refundStatus
				+ ", refundCompleteTime=" + refundCompleteTime + ", refundOrderId=" + refundOrderId
				+ ", refundTradeSeq=" + refundTradeSeq + ", tradeAmt=" + tradeAmt + ", refundAmt=" + refundAmt + "]";
	}
