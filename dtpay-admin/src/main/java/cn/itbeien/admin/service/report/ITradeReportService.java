...
public interface ITradeReportService {
    List<TradeReport> qryTradeReportByPage(TradeReportQryPar tradeReportQryPar) throws Exception;
    List<TradeReport> qryTradeReport(TradeReportQryPar tradeReportQryPar) throws Exception;
}
