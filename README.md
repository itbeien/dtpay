...
| 模块           | 说明                           | 进度   | 优先级 |
| -------------- | ------------------------------ | ------ | ------ |
| dtpay-merchant | 商户管理后台，电子钱包         | 进行中 | 高     |
...
| itbeien-mt     | 安全、权限认证、系统管理模块   |      |
| dtpay-payment  | 支付交易系统                   | 9028 |
| dtpay-admin    | 运营平台                       | 9029 |
| dtpay-merchant | 商户平台、电子钱包             | 9030 |
| dtpay-task     | 定时任务(佣金，对账)、报表系统 | 9031 |

## 7 加入我的社群

![](https://gitee.com/itbeien/base/raw/master/images/星球-贝恩聊架构.png)
