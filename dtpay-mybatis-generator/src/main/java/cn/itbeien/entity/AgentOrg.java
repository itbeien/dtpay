...
public class AgentOrg {
    ...
    private String legalIdentitycardPositive;

    private String legalIdentitycardOpposite;
    ...
    public void setLegalIdentitycardPositive(String legalIdentitycardPositive) {
        this.legalIdentitycardPositive = legalIdentitycardPositive == null ? null : legalIdentitycardPositive.trim();
    }
    ...
    public void setLegalIdentitycardOpposite(String legalIdentitycardOpposite) {
        this.legalIdentitycardOpposite = legalIdentitycardOpposite == null ? null : legalIdentitycardOpposite.trim();
    }
